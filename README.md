...
![image alt](imagem teste ping)

Com o ambiente configurado, iniciamos os primeiros testes de acesso para a nossa máquina virtual alvo.

![image alt](imagem de teste)
